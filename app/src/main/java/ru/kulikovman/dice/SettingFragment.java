...
import ru.kulikovman.dice.databinding.FragmentSettingBinding;
...
import ru.kulikovman.dice.util.sweet.SweetOnSeekBarChangeListener;
...
public class SettingFragment extends Fragment {
    ...
    private void restoreSettings() {
        ...
        String color = settings.getTypeOfCube();
    ...
    private void updateNumberOfCubes() {
        // Получаем максимальное значение кубиков
        maxCubes = model.getMaxCubes();

        // Устанавливаем максимум и текущий прогресс
    ...
    private void initUI() {
        ...
        binding.cubes.setOnSeekBarChangeListener(new SweetOnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                model.playSound(SoundManager.SEEKBAR_CLICK_SOUND);
        ...
        binding.doNotRollCubes.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                model.playSound(SoundManager.SWITCH_CLICK_SOUND);
        ...
        binding.showThrowAmount.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                // Сохраняем состояние
                settings.setShowTotal(isChecked);
            }
        });
    ...
    public void clickChooseCube(View view) {
        ...
        model.playSound(SoundManager.CUBE_CLICK_SOUND);

        // Сохраняем выбранный цвет
        settings.setTypeOfCube(cubeView.getCubeColor());
    }
}
